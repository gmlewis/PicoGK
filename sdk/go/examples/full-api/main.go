...
func main() {
	...
	do(picogk.CreateCylinder{X: 0, Y: 0, Z: 0, Radius: 5, Height: 40, DirX: picogk.Ptr(1.0), DirY: picogk.Ptr(0.0), DirZ: picogk.Ptr(0.0), ID: "cylX"})
	...
	do(picogk.OverOffset{ObjectID: "sphere1", FirstOffset: 2, FinalSurfaceDist: picogk.Ptr(0.5), ID: "over1"})
	...
	do(picogk.Shell{ObjectID: "sphere1", InnerOffset: 2, OuterOffset: 0, Smooth: picogk.Ptr(0.5), ID: "shell1"})
	do(picogk.Fillet{ObjectID: "box1", Radius: 1.5, ID: "fillet1"})
	do(picogk.ProjectZSlice{ObjectID: "sphere1", StartZ: -5, EndZ: 5, ID: "proj1"})
	do(picogk.TransformVoxels{ObjectID: "sphere1", TranslateX: picogk.Ptr(100.0), RotateZ: picogk.Ptr(45.0), ID: "moved1"})
	do(picogk.CircularPattern{ObjectID: "cylX", Count: 4, TotalAngle: picogk.Ptr(360.0), CenterX: picogk.Ptr(0.0), CenterY: picogk.Ptr(0.0), CenterZ: picogk.Ptr(0.0), AxisX: picogk.Ptr(0.0), AxisY: picogk.Ptr(0.0), AxisZ: picogk.Ptr(1.0), ID: "pattern1"})
	...
	do(picogk.MeshTransform{MeshID: "sphereMesh", Scale: picogk.Ptr(2.0), TranslateX: picogk.Ptr(50.0), ID: "mesh2x"})
	...
	do(picogk.SaveCLI{VoxelsID: "sphere1", Path: filepath.Join(outdir, "sphere.cli"), LayerHeight: picogk.Ptr(2.0)})
	do(picogk.SaveSVG{VoxelsID: "sphere1", Path: filepath.Join(outdir, "sphere.svg"), LayerHeight: picogk.Ptr(2.0)})

	// --- Render ---
	fmt.Println("\n--- Render ---")
	do(picogk.RenderToImage{ObjectID: "sphere1", Path: filepath.Join(outdir, "sphere.png"), Width: picogk.Ptr(600), Height: picogk.Ptr(400)})
	...
	do(picogk.DeleteObjects{ObjectIDs: []string{"sphere1"}, KeepOnly: picogk.Ptr(true)})
